import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, toRef, isRef, defineComponent, h, useAttrs, computed, toValue, useSSRContext, provide, shallowReactive, Suspense, nextTick, Transition, unref, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, withAsyncContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, isShallow, isReactive, toRaw, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames, unpackMeta } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/h3/dist/index.mjs';
import { hasProtocol, joinURL, parseURL, parseQuery, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/ufo/dist/index.mjs';
import { defuFn, createDefu, defu } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/defu/dist/defu.mjs';
import { klona } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/klona/dist/index.mjs';
import { extendTailwindMerge, twMerge, twJoin } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/tailwind-merge/dist/tailwind-merge.mjs';
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderList, ssrRenderClass } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/vue/server-renderer/index.mjs';
import { isEqual } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/ohash/dist/index.mjs';
import { Icon as Icon$1 } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/@iconify/vue/dist/offline.mjs';
import { addAPIProvider, loadIcon } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/@iconify/vue/dist/iconify.mjs';
import { useFixedHeader } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/vue-use-fixed-header/dist/index.js';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-wblUlCZX.mjs').then((m) => m.default || m)
  },
  {
    name: "lab",
    path: "/lab",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-B0ntXDqV.mjs').then((m) => m.default || m)
  }
];
...
const inlineConfig = {
  "nuxt": {
    "buildId": "d97723b7-45e0-4779-b62f-f0d5a35a9014"
  },
  "ui": {
    "primary": "green",
    "gray": "cool",
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-BA4DVa5X.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./_nuxt/ProsePre-BCe7-UHp.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-DGyGGLvQ.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-Vz9CBnj6.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-BZfTzBgR.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-BIjzHUbs.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-gTUy-4Ym.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-DvX7LbuP.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-ClwEPw7z.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-CFdWs2Vd.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-DdNFMB7X.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-swhHzCwF.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-CDn8yoja.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-DfApHsEP.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-BU-At4pu.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-CzeGyG3k.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./_nuxt/ProseScript-D0R07iM6.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-BaOdaFoL.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-CB2ggvas.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-B34qnGLe.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-BDPwJvHG.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-CrZHh7ls.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-cVZhaywO.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-CwFaXouM.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-DCU2Ibd0.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-DIxXqqHJ.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-xUSrBDOz.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-BDqkZvuQ.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
