...
import { useSSRContext, withCtx, createVNode, toDisplayString } from 'file:///Users/murtadha.ramadhan/Documents/personal-website-3/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex gap-2 items-center"><p class="text-gray-600 dark:text-gray-400 text-sm">Techs/skills:</p><span class="bg-blue-500 text-white px-2 py-1 rounded-lg text-xs">${ssrInterpolate(__props.project.tech1)}</span><span class="bg-blue-500 text-white px-2 py-1 rounded-lg text-xs">${ssrInterpolate(__props.project.tech2)}</span><span class="bg-blue-500 text-white px-2 py-1 rounded-lg text-xs">${ssrInterpolate(__props.project.tech3)}</span></div><!--]-->`);
    };
  }
};
...
//# sourceMappingURL=ProjectCard-BpcCOczd.mjs.map
