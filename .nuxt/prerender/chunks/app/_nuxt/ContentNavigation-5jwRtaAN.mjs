import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BP-k-7-9.mjs';
import { p as useState, e as useRuntimeConfig, a as __nuxt_component_0$2 } from '../server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-Hrz82S0B.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-5jwRtaAN.mjs.map
