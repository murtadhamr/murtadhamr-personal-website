...
import { l as asyncDataDefaults, f as useNuxtApp, c as createError, e as useRuntimeConfig } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-ldLwvb85.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-NDHSx6pe.mjs.map
