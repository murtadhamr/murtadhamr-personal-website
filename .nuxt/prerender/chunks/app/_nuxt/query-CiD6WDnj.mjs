...
import { u as useRequestEvent, a as useContentPreview } from './preview-CLC3vvQY.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DtWDoH6u.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CiD6WDnj.mjs.map
