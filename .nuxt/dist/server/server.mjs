...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-BG80Z-by.js").then((m) => m.default || m)
  },
  {
    name: "articles",
    path: "/articles",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-zuDvGwry.js").then((m) => m.default || m)
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/bookmarks-KWYxJafU.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-CXib3tAW.js").then((m) => m.default || m)
  },
  {
    name: "lab",
    path: "/lab",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/lab-CbnmoZ4B.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/projects-BVt4ZQWt.js").then((m) => m.default || m)
  }
];
