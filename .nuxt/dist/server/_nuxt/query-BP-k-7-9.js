...
import { u as useRequestEvent, a as useContentPreview } from "./preview-G4lUPvVq.js";
import "destr";
import "klona";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-Hrz82S0B.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BP-k-7-9.js.map
