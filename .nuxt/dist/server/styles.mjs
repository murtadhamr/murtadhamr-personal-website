...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.B4VPRAuw.mjs').then(interopDefault),
  ...
  "pages/articles/[slug].vue": () => import('./_nuxt/_slug_-styles.CK-vFgau.mjs').then(interopDefault),
  "node_modules/nuxt-icon/dist/runtime/IconCSS.vue": () => import('./_nuxt/IconCSS-styles.CQL8WjFP.mjs').then(interopDefault),
  "node_modules/@nuxt/ui-templates/dist/templates/error-404.vue": () => import('./_nuxt/error-404-styles.DFsHqWlc.mjs').then(interopDefault),
  "node_modules/@nuxt/ui-templates/dist/templates/error-500.vue": () => import('./_nuxt/error-500-styles.CMirSWuO.mjs').then(interopDefault)
}